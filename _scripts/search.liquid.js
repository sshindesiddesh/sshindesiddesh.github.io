          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/blogs/" -%}{%- assign url = "/blogs/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/blogs/" -%}{%- assign url = "/blogs/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
